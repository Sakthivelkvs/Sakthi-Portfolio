...
const socialLinks = [
  {
    href: "https://github.com/Sakthivelkvs",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/sakthivel-k04/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://x.com/sakthivel512316",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/sakkthiii_/",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form action="https://getform.io/f/apjjjgda" method="POST" className="xl:pl-10 2xl:pl-20">
